  ...
  return (
    <AppShell>
      ...
      <section className="px-5 pb-3 flex items-center justify-between">
        ...
        <Button variant="secondary" size="sm" onPress={() => navigate('/messages/ag_builtin_meta-xiaozao')}>去找阿空小造</Button>
      </section>

      <div className="px-3 pb-6">
        {roles.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 px-8 text-center">
            <p className="text-[14px] text-[var(--ak-fg-secondary)] leading-relaxed mb-5">还没有艺人 · 去消息里找阿空小造聊几句造一个</p>
            <Button variant="primary" size="lg" onPress={() => navigate('/messages')}>去找阿空小造</Button>
          </div>
        ) : (
