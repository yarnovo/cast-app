...
/**
 * e2e · 真人造 agent 全链路 (单轮 smoke)
 *
 * 验证: cast-app /create → 用户输入 → cast-agents /api/agent/run (sync · session 持久化) →
 *      meta-xiaozao LLM → 返 RunResult.final_text 渲染 1 条 assistant 气泡。
 *
 ...
 *   3. 输入 "你好" 发送
 *   4. user 气泡出现
 *   5. 等 LLM (≤60s) · assistant 气泡 (final_text) 非空
 *
